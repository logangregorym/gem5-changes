...
type="parsec_artifact_evaluation_lvpraw"
...
#SBATCH --job-name=${parsec_bench_names[$1]}-r
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -c 1
#
...
#${parsec_bench_commands[$1]} ${bench_input}

${home_root}/${gem5} --outdir=m5out_sim_${parsec_bench_names[$1]}_${type} ${home_root}/${gem5_config} -c ${parsec_bench_commands[$1]} -o '${bench_input}' --caches --l2cache --cpu-type=O3_X86_icelake_1   --mem-type=DDR4_2400_16x4 --mem-size=64GB --mem-channels=2  --enable-microop-cache --uopCacheNumSets=48 --uopCacheNumWays=8 --uopCacheNumUops=6 --enable-micro-fusion  --l3cache --lvpredType=fa3p --dynamicThreshold=5 --constantThreshold=3 --predictionConfidenceThreshold=15 --enableValuePredForwarding --predictingArithmetic=1 --enableDynamicThreshold --forceNoTSO --uopCacheNumTicks=28

#${home_root}/${gem5} --outdir=m5out_sim_${parsec_bench_names[$1]}_${type} ${home_root}/${gem5_config} -c ${parsec_bench_commands[$1]} -o '${bench_input}' --caches --l2cache --cpu-type=O3_X86_icelake_1   --mem-type=DDR4_2400_16x4 --mem-size=64GB --mem-channels=2  --enable-microop-cache --uopCacheNumSets=48 --uopCacheNumWays=8 --uopCacheNumUops=6 --enable-micro-fusion  --l3cache --forceNoTSO
