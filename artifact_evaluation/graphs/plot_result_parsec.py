...
type1 = "parsec_artifact_evaluation_lvpraw"
type2 = "parsec_artifact_evaluation_super"


file_type = "parsec-results"
...
final_results_performance = {    'benchmark':  [ 'vips', 'x264', 'freqmine',  'swaptions', 'dedup', 'blackscholes',  'ferret', 'streamcluster', "", "PARSEC Geomean"],
                                'Raw':[],
                                 'Super':[]
                                 }
...
def get_power_results():
        ...
        power_file = open('../check_power_parsec.out', mode='r')
        ...
        assert(len(power_results_split) == 8)
        ...
        power_results  = {                     
                ...
                'vips': [power_results_split[0]], 
                'x264': [power_results_split[2]], 
                'freqmine': [power_results_split[1]], 
                'swaptions': [power_results_split[3]], 
                'dedup': [power_results_split[4]], 
                'blackscholes': [power_results_split[5]], 
                'ferret': [power_results_split[6]],
                'streamcluster': [power_results_split[7]]
                }
