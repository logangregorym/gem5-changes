...
#ifndef __CPU_PRED_THREE_PERIOD_HH__
#define __CPU_PRED_THREE_PERIOD_HH__
...
class ThreePeriodLVP : public LVPredUnit
{
  public:
...
#endif //__CPU_PRED_THREE_PERIOD_HH__
